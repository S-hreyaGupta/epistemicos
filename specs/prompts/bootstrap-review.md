...
scripts/test_run_review.py       47 controls
scripts/test_ledger.py           45 controls, covering the ledger and controller
scripts/test_bootstrap_gate.py   30 controls
scripts/test_interfaces.py       17 controls, across six component seams
```
