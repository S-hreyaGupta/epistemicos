<!--
SUPERSEDED_BOOTSTRAP_PROMPT

Retained per Alex Zamurko, 8 September, rather than overwritten.

This version named three artifacts: the evidence schema, the MC-2 checker and
the review runner. The finding ledger and loop controller were built after it
was written, so it was frozen a step too early and calling it frozen was
premature.

It was never used. No review was run against it and no cycle references it, so
nothing is contaminated. It is kept because a superseded frozen artifact is
evidence about how the process ran, and deleting it would remove the record that
the first freeze was wrong.

Superseded by specs/prompts/bootstrap-review.md, which covers all five.

original commit  8c6a902
original sha256  8a8381878ab222f9a25bec3fe198824a1d44f92383072827351d33bd4623c9ac
-->
