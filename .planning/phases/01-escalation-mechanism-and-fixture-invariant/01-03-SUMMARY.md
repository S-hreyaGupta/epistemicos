...
None beyond the one-time `make` install performed by the orchestrator during this run under the operator's explicit approval (recorded above). No further external service configuration is required.
